...
SelectUIPanel::SelectUIPanel(Vector2i res) :
	// Create a new UIPanel by calling the
	// super-class constructor
	UIPanel(res, (res.x / 10) * 2, // Start 2/10 across
		res.y / 3, // 1/3 of resolution from top
		(res.x / 10) * 6, // as wide as 6/10 of resolution
...
void SelectUIPanel::initialiseButtons() {
	...
	// corner of the UI planel(m_View in UIPanel)
