...
UIPanel::UIPanel(Vector2i res, int x, int y,
	...
	// Where in pixels does the center og the view focus
	...
	// Params from left to right (ALL fraction of 1)
...
void UIPanel::addButton(float x, float y, int width, int height,
	...
	m_Buttons.push_back(make_shared<Button>(Vector2f(x, y), width, height,
